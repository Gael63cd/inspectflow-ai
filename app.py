...
# Téléchargement automatique d'un modèle valide si best.pt est corrompu
MODEL_PATH = "best.pt"

@st.cache_resource
def load_model():
    # Vérifier si le fichier existe ou s'il est trop petit (corrompu)
    if not os.path.exists(MODEL_PATH) or os.path.getsize(MODEL_PATH) < 1000000:
        st.sidebar.info("⏳ Initialisation du modèle de segmentation...")
        url = "https://huggingface.co/fabiocaprini/fissure-segmentation-yolov8/resolve/main/best.pt"
